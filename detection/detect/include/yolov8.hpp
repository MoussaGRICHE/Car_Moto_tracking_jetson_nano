...
void draw_objects(
    ...
    for (const auto& obj : objs) {
        // Check if the object class is in DISPLAYED_CLASS_NAMES
        auto it = std::find(DISPLAYED_CLASS_NAMES.begin(), DISPLAYED_CLASS_NAMES.end(), CLASS_NAMES[obj.label]);
        if (it != DISPLAYED_CLASS_NAMES.end()) {
